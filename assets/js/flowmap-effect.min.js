var ogl = (function (t) {
      ...
      this.gl.renderer.currentProgram === this.id ||
        ...
        this.uniformLocations.forEach((t, i) => {
          ...
          if (
            ...
            return M(`Active uniform ${r} has not been supplied`);
          if (s && void 0 === s.value)
            return M(`${r} uniform is missing a value parameter`);
          if (s.value.texture)
            return (e += 1), s.value.update(e), x(this.gl, i.type, t, e);
  ...
  class N extends Array {
    ...
    set(t, e, i, r) {
      return t.length
        ? this.copy(t)
        : (_(this, t, e, i, r), this.onChange(), this);
    }
    rotateX(t) {
      return (
        (function (t, e, i) {
  ...
  function L(t, e, i) {
    ...
    return (
      ...
      (t[8] = b * r + M * h + v * c + A * m),
      (t[9] = b * s + M * o + v * d + A * f),
      (t[10] = b * n + M * l + v * g + A * x),
      (t[11] = b * a + M * u + v * p + A * w),
      (b = i[12]),
      (M = i[13]),
      (v = i[14]),
      (A = i[15]),
      (t[12] = b * r + M * h + v * c + A * m),
      (t[13] = b * s + M * o + v * d + A * f),
      (t[14] = b * n + M * l + v * g + A * x),
      (t[15] = b * a + M * u + v * p + A * w),
      t
    );
  }
  class P extends Array {
    ...
    set(t, e, i, r, s, n, a, h, o, l, u, c, d, g, p, m) {
      return t.length
        ? this.copy(t)
        : ((function (t, e, i, r, s, n, a, h, o, l, u, c, d, g, p, m, f) {
            (t[0] = e),
              (t[1] = i),
              (t[2] = r),
              (t[3] = s),
              ...
              (t[14] = m),
              (t[15] = f);
          })(this, t, e, i, r, s, n, a, h, o, l, u, c, d, g, p, m),
          this);
    }
    translate(t, e = this) {
      return (
        (function (t, e, i) {
          let r,
            ...
            x = i[2];
          e === t
            ? ((t[12] = e[0] * m + e[4] * f + e[8] * x + e[12]),
              (t[13] = e[1] * m + e[5] * f + e[9] * x + e[13]),
              (t[14] = e[2] * m + e[6] * f + e[10] * x + e[14]),
              (t[15] = e[3] * m + e[7] * f + e[11] * x + e[15]))
            : ((r = e[0]),
              (s = e[1]),
              (n = e[2]),
              (a = e[3]),
              ...
              (t[10] = g),
              (t[11] = p),
              (t[12] = r * m + h * f + c * x + e[12]),
              (t[13] = s * m + o * f + d * x + e[13]),
              (t[14] = n * m + l * f + g * x + e[14]),
              (t[15] = a * m + u * f + p * x + e[15]));
        })(this, e, t),
        this
      );
    }
  ...
  class Y extends C {
    ...
    draw({ camera: t } = {}) {
      this.onBeforeRender && this.onBeforeRender({ mesh: this, camera: t }),
        t &&
      ...
      this.program.use({ flipFaces: e }),
        ...
        this.onAfterRender && this.onAfterRender({ mesh: this, camera: t });
    }
  }
        ...
        e &&
          ...
          this.image
            ? (this.image.width &&
              ...
              this.gl.renderer.isWebgl2 || ArrayBuffer.isView(this.image)
                ? this.gl.texImage2D(
                    this.target,
                    this.level,
                    this.internalFormat,
  ...
  class H extends Array {
    constructor(t = 0, e = 0, i = 0) {
      return (
        "string" == typeof t && ([t, e, i] = H.hexToRGB(t)),
        super(t, e, i),
        this
      );
    }
    ...
    set(t, e, i) {
      return (
        ...
        t.length
          ? this.copy(t)
          : ((this[0] = t), (this[1] = e), (this[2] = i), this)
      );
    }
    copy(t) {
      return (this[0] = t[0]), (this[1] = t[1]), (this[2] = t[2]), this;
  ...
  class tt extends g {
    constructor(
      ...
      tt.buildPlane(u, c, d, g, e, i, 0, a, h),
        Object.assign(n, {
  ...
  const et = { NONE: -1, ROTATE: 0, DOLLY: 1, PAN: 2, DOLLY_PAN: 3 },
    it = new l(),
    rt = new J(),
    st = new J();
  const nt = new l(),
  ...
  class xt {
    ...
    update(t = 1, e) {
      ...
      this.objects.forEach((t, e) => {
        ct.fromArray(a.position, 3 * e),
          dt.fromArray(a.quaternion, 4 * e),
          gt.fromArray(a.scale, 3 * e),
          pt.fromArray(h.position, 3 * e),
          mt.fromArray(h.quaternion, 4 * e),
          ft.fromArray(h.scale, 3 * e),
          ct.lerp(pt, n),
          dt.slerp(mt, n),
          gt.lerp(ft, n),
          t.position.lerp(ct, i),
          t.quaternion.slerp(dt, i),
          t.scale.lerp(gt, i);
      });
    }
  }
  ...
  return (
    ...
    (t.Box = class extends g {
      constructor(
        ...
        let x = 0,
          w = 0;
        tt.buildPlane(g, p, m, f, r, i, e, u, l, 2, 1, 0, -1, -1, x, w),
          tt.buildPlane(
            g,
            p,
            m,
    ...
    (t.Camera = class extends C {
      constructor(
        ...
        super(t),
          ...
          n || a
            ? this.orthographic({ left: n, right: a, bottom: h, top: o })
            : this.perspective();
      }
      perspective({
        near: t = this.near,
      ...
      unproject(t) {
        return (
          t.applyMatrix4(D.inverse(this.projectionMatrix)),
    ...
    (t.Cylinder = class extends g {
      constructor(
        ...
        for (var A = 0; A < a + 1; A++) {
          ...
          for (var E = 0; E < h + 1; E++) {
            let r = E / h;
            (m = Math.cos(t * Math.PI * 2) * e),
              (f = (r - 0.5) * i),
              (x = Math.sin(t * Math.PI * 2) * e),
              (c[3 * w + 0] = m),
              (c[3 * w + 1] = f),
              (c[3 * w + 2] = x),
              b.set(m, f, x).normalize(),
          ...
          (function () {
            let i =
              t.renderer.extensions[
                `OES_texture_${t.renderer.isWebgl2 ? "" : "half_"}float_linear`
              ];
            const r = {
              width: e,
              height: e,
              type: t.renderer.isWebgl2
                ? t.HALF_FLOAT
                : t.renderer.extensions.OES_texture_half_float
            ...
            (n.mask.read = new j(t, r)),
              (n.mask.write = new j(t, r)),
              n.mask.swap();
          })(),
          (this.aspect = 1),
          (this.mouse = new J()),
          ...
          (this.mesh = new Y(t, {
            ...
            program: new f(t, {
              ...
              uniforms: {
                ...
                uAlpha: { value: r },
                uDissipation: { value: s },
                uAspect: { value: 1 },
                uMouse: { value: n.mouse },
                uVelocity: { value: n.velocity },
              },
              depthTest: !1,
            }),
          }));
    ...
    (t.GPGPU = class {
      constructor(
        ...
        (this.passes = []),
          ...
          (this.size = Math.pow(
            2,
            Math.ceil(
              Math.log(Math.ceil(Math.sqrt(this.dataLength))) / Math.LN2
            )
          )),
      ...
      addPass({
        ...
        i[r] = this.uniform;
        const n = new f(this.gl, { vertex: t, fragment: e, uniforms: i }),
          a = {
            mesh: new Y(this.gl, { geometry: this.geometry, program: n }),
            program: n,
            uniforms: i,
            enabled: s,
            textureUniform: r,
    ...
    (t.Mat4 = P),
    (t.Mesh = Y),
    (t.NormalProgram = function (t) {
      return new f(t, { vertex: bt, fragment: Mt });
    }),
    (t.Orbit = function (
      t,
      {
      ...
      (this.enabled = i),
        ...
        (this.minDistance = x),
        (this.maxDistance = w);
      const b = { radius: 1, phi: 0, theta: 0 },
        M = { radius: 1, phi: 0, theta: 0 },
        v = { radius: 1, phi: 0, theta: 0 },
        A = new l(),
        E = new l();
      E.copy(t.position).sub(this.target),
        (v.radius = M.radius = E.distance()),
        (v.theta = M.theta = Math.atan2(E.x, E.z)),
        (v.phi = M.phi = Math.acos(Math.min(Math.max(E.y / M.radius, -1), 1))),
        (this.update = () => {
          (M.radius *= b.radius),
            (M.theta += b.theta),
            (M.phi += b.phi),
            (M.theta = Math.max(m, Math.min(f, M.theta))),
            (M.phi = Math.max(g, Math.min(p, M.phi))),
            (M.radius = Math.max(
              this.minDistance,
              Math.min(this.maxDistance, M.radius)
            )),
            (v.phi += (M.phi - v.phi) * s),
            (v.theta += (M.theta - v.theta) * s),
            (v.radius += (M.radius - v.radius) * s),
            this.target.add(A);
          let e = v.radius * Math.sin(Math.max(1e-6, v.phi));
          (E.x = e * Math.sin(v.theta)),
            (E.y = v.radius * Math.cos(v.phi)),
            (E.z = e * Math.cos(v.theta)),
            t.position.copy(this.target).add(E),
      ...
      const S = (i, r) => {
        ...
        (function (t, e) {
          ...
          (2 * i * (n *= Math.tan((((t.fov || 45) / 2) * Math.PI) / 180))) /
            s.clientHeight,
          t.matrix
        ),
          (function (t, e) {
      ...
      function L(t, i) {
        ...
        (b.theta -= (2 * Math.PI * st.x) / r.clientHeight),
      ...
      const O = (t) => {
          ...
          if (this.enabled)
            switch (_) {
              ...
              case et.DOLLY:
                if (!1 === o) return;
                !(function (t) {
                  rt.set(t.clientX, t.clientY),
                    st.sub(rt, T),
                    st.y > 0 ? N(R()) : st.y < 0 && N(1 / R()),
                    T.copy(rt);
                })(t);
                break;
              case et.PAN:
        ...
        D = (t) => {
          this.enabled &&
            o &&
            (_ === et.NONE || _ === et.ROTATE) &&
            (t.stopPropagation(),
            t.deltaY < 0 ? N(1 / R()) : t.deltaY > 0 && N(R()));
        },
        U = (t) => {
          if (this.enabled)
                ...
                !(function (t) {
                  ...
                  if (c) {
                    let e = 0.5 * (t.touches[0].pageX + t.touches[1].pageX),
                      i = 0.5 * (t.touches[0].pageY + t.touches[1].pageY);
                    F.set(e, i);
                  }
                })(t),
                  (_ = et.DOLLY_PAN);
      ...
      (this.remove = function () {
        e.removeEventListener("contextmenu", q, !1),
          ...
          window.removeEventListener("wheel", D, !1),
        ...
        window.addEventListener("wheel", D, !1),
        e.addEventListener("touchstart", U, { passive: !1 }),
        e.addEventListener("touchend", I, !1),
        e.addEventListener("touchmove", z, { passive: !1 });
    }),
    (t.Plane = tt),
    (t.Post = class {
      constructor(
        ...
        (this.gl = t),
          (this.options = { wrapS: s, wrapT: n, minFilter: a, magFilter: h }),
          (this.passes = []),
          (this.geometry = o);
        const l = (this.fbo = {
          read: null,
        ...
        this.resize({ width: e, height: i, dpr: r });
      }
      addPass({
        vertex: t = lt,
        fragment: e = ut,
        ...
        i[r] = { value: this.fbo.read.texture };
        const n = new f(this.gl, { vertex: t, fragment: e, uniforms: i }),
          a = {
            mesh: new Y(this.gl, { geometry: this.geometry, program: n }),
            program: n,
      ...
      resize({ width: t, height: e, dpr: i } = {}) {
        i && (this.dpr = i),
          ...
          (this.fbo.read = new j(this.gl, this.options)),
          (this.fbo.write = new j(this.gl, this.options));
      }
      render({
        scene: t,
        camera: e,
    ...
    (t.Raycast = class {
      ...
      intersectBounds(t) {
        ...
        return (
          t.forEach((t) => {
            ...
            (n =
              "sphere" === t.geometry.raycast
                ? this.intersectSphere(t.geometry.bounds, i, r)
                : this.intersectBox(t.geometry.bounds, i, r)) &&
              (t.hit || (t.hit = { localPoint: new l() }),
              (t.hit.distance = n),
      ...
      intersectBox(t, e = this.origin, i = this.direction) {
        ...
        return (
          ...
          (s = ((l >= 0 ? g.x : d.x) - e.x) * l),
          (n = ((u >= 0 ? d.y : g.y) - e.y) * u),
          r > (a = ((u >= 0 ? g.y : d.y) - e.y) * u) || n > s
            ? 0
            : (n > r && (r = n),
              a < s && (s = a),
              (h = ((c >= 0 ? d.z : g.z) - e.z) * c),
              r > (o = ((c >= 0 ? g.z : d.z) - e.z) * c) || h > s
                ? 0
                : (h > r && (r = h),
                  o < s && (s = o),
                  s < 0 ? 0 : r >= 0 ? r : s))
          ...
          s.forEach((s) => {
            s.program.transparent
              ...
              0 === s.renderOrder &&
                s.program.depthTest &&
                e &&
                (s.worldMatrix.getTranslation(v),
                v.applyMatrix4(e.projectionViewMatrix),
                (s.zDepth = v.z));
          }),
    ...
    (t.Skin = class extends Y {
      constructor(
        t,
        { rig: e, geometry: i, program: r, mode: s = t.TRIANGLES } = {}
      ) {
        super(t, { geometry: i, program: r, mode: s }),
          this.createBones(e),
      ...
      createBones(t) {
        if (
          ((this.root = new C()), (this.bones = []), t.bones && t.bones.length)
        ) {
      ...
      createBoneTexture() {
        ...
        (this.boneMatrices = new Float32Array(t * t * 4)),
          ...
          (this.boneTexture = new W(this.gl, {
      ...
      addAnimation(t) {
        const e = new xt({ objects: this.bones, data: t });
      ...
      draw({ camera: t } = {}) {
        this.root.updateMatrixWorld(!0),
          this.bones.forEach((t, e) => {
            wt.multiply(t.worldMatrix, t.bindInverse),
              this.boneMatrices.set(wt, 16 * e);
          }),
    ...
    (t.Sphere = class extends g {
      constructor(
        t,
        {
          radius: e = 0.5,
          widthSegments: i = 16,
          heightSegments: r = Math.ceil(0.5 * i),
          phiStart: s = 0,
        ...
        for (let t = 0; t < c; t++)
          for (let e = 0; e < u; e++) {
            let i = T[t][e + 1],
              ...
              n = T[t + 1][e + 1];
            (0 !== t || p > 0) &&
              ((v[3 * y] = i), (v[3 * y + 1] = r), (v[3 * y + 2] = n), y++),
              (t !== c - 1 || F < Math.PI) &&
                ((v[3 * y] = r), (v[3 * y + 1] = s), (v[3 * y + 2] = n), y++);
          }
        Object.assign(o, {
          position: { size: 3, data: w },
            ...
            for (let t = 0; t < e.length; t++) {
              ...
              for (let t = 0; t < l.glyphs.length; t++) {
                ...
                let a = e.width * p,
                  u = e.height * p;
                c.position.set(
                  [s, h - u, 0, s, h, 0, s + a, h - u, 0, s + a, h, 0],
                  4 * o * 3
                );
                let d = e.x / i,
                  g = e.width / i,
                  m = 1 - e.y / n,
                  x = e.height / n;
                c.uv.set([d, m - x, d, m, d + g, m - x, d + g, m], 4 * o * 2),
                  (h += e.yoffset * p),
                  o++;
              }
              h -= s * a;
